...
%% priceAsianArithmeticMeanCall: Price of a Asian call option on the 
% arithmetic mean in the Black-Scholes model
%
%% SYNTAX:
...
payoff = max(mean(S(:,2:end),2) - K,0);
% payoff = max(mean(S(:,2:end)') - K,0); % Alternative
